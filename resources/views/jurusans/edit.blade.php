...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">jurusans</h1>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('jurusans.update', $jurusan->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="jurusan" type="text" class="form-control @error('jurusan') is-invalid @enderror"
                                        name="jurusan" value="{{ old('jurusan', $jurusan->jurusan) }}" required
                                        autocomplete="jurusan" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    required autocomplete="teks" autofocus>{{ old('teks', $jurusan->teks) }}</textarea>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="icon" type="text" class="form-control @error('icon') is-invalid @enderror"
                                        name="icon" value="{{ old('icon', $jurusan->icon) }}" required
                ...
                <div class="m-2 p-2">
                    <form method="POST" action="{{ route('jurusans.destroy', $jurusan->id) }}">
                        @csrf
                        @method('DELETE')
                        <button class="btn btn-danger">Delete {{ $jurusan->jurusan }}</button>
                    </form>
                </div>
            </div>
        </div>
